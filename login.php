  ...
  <div id="about" class="about-us section">
    <div class="container">
      <div class="row">
        ...
        <form id="contact" style="width: 520px; height: 570px; ; margin-left: 300px; margin-top:-90px ;" action="ceklogin.php" method="post">
            <div>
              <center style="margin-top:-90px ;" ><h3>L O G I N</h3></center>
            </div>
            ...
            <div class="form-group" style="text-align: center; width: 150px;">
             ...
             <div class="form-group">
                <label for="isi-captcha">Isikan Captcha</label>
                <input name="captcha" value="" class="form-control" maxlength="5" required>
                    </div>
